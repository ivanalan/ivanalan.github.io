...
team: Just me
year: 2025
metrics: "26 installs, 5 likes"
status: published
coverVideo: "/media/side-projects/table-layout-switcher/cover.mp4"
coverVideoPoster: "/media/side-projects/table-layout-switcher/cover-poster.webp"
...
<CaseImage
  client:load
  src="/media/side-projects/table-layout-switcher/figma-community.png"
...
<CaseVideo
  client:load
  src="/media/side-projects/table-layout-switcher/product-demo.mp4"
  poster="/media/side-projects/table-layout-switcher/product-demo-poster.webp"
  width={1712}
  height={1108}
